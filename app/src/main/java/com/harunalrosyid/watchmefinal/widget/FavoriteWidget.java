...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.harunalrosyid.watchmefinal.EXTRA_ITEM";
    private static final String REFRESH_ACTION = "com.harunalrosyid.watchmefinal.appwidget.action.REFRESH";
    private static final String TOAST_ACTION = "com.harunalrosyid.watchmefinal.TOAST_ACTION";
